...
<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Daftar requisition</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">requisition</a></li>
                                <li class="breadcrumb-item active">Daftar requisition</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data requisition</h4>
    ...
    $(function () {
        ...
        $('#requisitionModal form').on('submit',function(e){
            if(!e.isDefaultPrevented()){
                var id = $('#id').val();
                // var idmax = 1;
                if(save_method == "add") url = "{{route('createspr') }}";
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        window.location.href = "{{route('requisition.show',$idmax)}}"
