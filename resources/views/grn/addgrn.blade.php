<div class="modal fade bs-example-modal-lg" id="grnModal" tabindex="-1" role="dialog"
    aria-labelledby="grnModal1">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="grnModal1">Input New grn</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
            </div>
            <form data-toggle="validator" method="post" id="grnModal"
                ...
                <div class="modal-body">
                  ...
                  <div class="table-responsive m-t-40">
                        <table id="tabeladdgrn" class="display nowrap table table-hover table-striped table-bordered"
