...
@endif
    ...
    <tr>
      ...
      <td>: {{$po->po_delivery_instruction}} </td>
    </tr> 
    <tr>
      <td>SPR Number</td>
      <td>: {{$po->pr_alias}} </td>
      ...
      <div class="content">
        <table id="judul">
          ...
          <tr>
            ...
            <td>{{$part->qty}} </td>
            <td>{{$part->uom}} </td>
            <td style="text-align:right;">{{format_uang($part->po_price)}} </td>
            <td style="text-align:right;">{{format_uang($part->total_price)}} </td>
            {{-- {{$total +=$part->total}} --}}
            {{$total}}
          </tr>
           @endforeach
          ...
          <tr>
            ...
            @if ($po->po_ppn == "Yes")
            <td style="text-align:right;">{{format_uang($total*0.1)}}</td>
            @else
            <td style="text-align:right;">{{format_uang($total*0)}}</td>
            @endif
          </tr>
          <tr>
            {{-- <td colspan="5"></td> --}}
            ...
            <td>Total</td>
            @if ($po->po_ppn == 'Yes')
            <td style="text-align:right;">{{format_uang($total+$total*0.1)}}</td>
            @else
            <td style="text-align:right;">{{format_uang($total+$total*0)}}</td>
            @endif
          </tr>
           </tbody>
           <tfoot>
