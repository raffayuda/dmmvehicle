                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('public/assets/images/users/1.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                ...
                                                <div class="carousel-item">
                                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('public/assets/images/users/2.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                    </span>
                                                ...
                                                <div class="carousel-item">
                                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('public/assets/images/users/3.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                    </span>
