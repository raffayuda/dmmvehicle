<div class="modal fade bs-example-modal-lg" id="workorderpackageModal" tabindex="-1" role="dialog"
    aria-labelledby="workorderpackageModal1">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="workorderpackageModal1">Input New workorderpackage</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
            </div>
            <form data-toggle="validator" method="post" id="workorderpackageModal"
