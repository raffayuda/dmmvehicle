...
@foreach ($workorders as $workorder)
    ...
    @elseif($workorder->packages_id == 16)
        @include('workorder.form'.$workorder->packages_id)
    @elseif($workorder->packages_id == 17)
        @include('workorder.form'.$workorder->packages_id)
    @elseif($workorder->packages_id == 18)
        @include('workorder.form'.$workorder->packages_id)
    @elseif($workorder->packages_id == 19)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 20)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 21)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 22)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 23)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 24)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 25)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 26)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 27)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 28)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 29)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 30)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 31)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 32)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 33)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 34)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 35)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 35)
        @include('workorder.form'.$workorder->packages_id)
        @elseif($workorder->packages_id == 37)
        @include('workorder.form'.$workorder->packages_id)
        @endif
@endforeach
