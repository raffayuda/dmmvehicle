<div class="modal fade bs-example-modal-lg" id="workorderpartModal" tabindex="-1" role="dialog"
    aria-labelledby="workorderpartModal1">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="workorderpartModal1">Input New workorderpart</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
            </div>
            <form data-toggle="validator" method="post" id="workorderpartModal"
